        ...
        <div className="card tarjeta-estadistica border-0 rounded-4 p-3 shadow-sm">
          <div className="card-body">
            <div className="d-flex justify-content-between align-items-center mb-2">
              ...
              <span className="badge fondo-advertencia-sutil texto-advertencia rounded-pill px-2 py-1">En cola</span>
            </div>
            <h2 className="fw-bold mb-0 texto-advertencia">{isLoading ? '—' : stats.pendientes}</h2>
        ...
        <div className="card tarjeta-estadistica border-0 rounded-4 p-3 shadow-sm">
          <div className="card-body">
            <div className="d-flex justify-content-between align-items-center mb-2">
              ...
              <span className="badge fondo-exito-sutil texto-exito rounded-pill px-2 py-1">Procesadas</span>
            </div>
            <h2 className="fw-bold mb-0 texto-exito">{isLoading ? '—' : stats.enviadas}</h2>
        ...
        <div className="card tarjeta-estadistica border-0 rounded-4 p-3 shadow-sm">
          <div className="card-body">
            <div className="d-flex justify-content-between align-items-center mb-2">
              ...
              <span className="badge fondo-error-sutil texto-error rounded-pill px-2 py-1">Revisar</span>
            </div>
            <h2 className="fw-bold mb-0 texto-error">{isLoading ? '—' : stats.fallidas}</h2>
